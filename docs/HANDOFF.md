...
> Ultimo aggiornamento: settembre 2026 · deploy asset `?v=52` · SW `bsp-v52` · backend V4.12.
...
- **`view-rotazioni`** — **Rotation chart** (sperimentale, da Altro → sezione "Analisi" → riga "Rotazioni"): back (→ Altro) + barra filtri (copia di quella di Analisi stagione) + griglia presenza-per-minuto/margine-per-minuto. Vedi `js/rotazioni.js`.
